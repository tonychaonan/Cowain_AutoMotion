...
namespace Cowain_AutoMotion
{
    public class RS232
    {
        public static bool connect232 = false;
        ...
        /* ****************************************************************** */
        public RS232(string portName, int iBaudRate)
        {
        ...
        public RS232(ComPortData readerPara)
        {
            components = new System.ComponentModel.Container();
            serialPort = new System.IO.Ports.SerialPort(this.components);
        ...
        public RS232(int nStation, string portName, int iBaudRate, int dataBits, System.IO.Ports.StopBits stopbits, System.IO.Ports.Parity parity)
        {
        ...
        public bool Opened { get { return serialPort.IsOpen; } }
