...
namespace Inovance.InoMotionCotrollerShop.InoServiceContract.EtherCATConfigApi
{
    ...
    public class ImcApi
    {
        ...
        */
        ...
        //_DLL_API UINT32 IMC_GetAxDbEdgCaptStatus (HANDLETYPE cardHandle,INT16 axNo,INT16 *pSts,INT32 *pCaptPos);
        //连续捕获
        //_DLL_API UINT32 IMC_SetAxCaptRepeat(UINT64 cardHandle, INT16 axNo, INT16 count);
        //_DLL_API UINT32 IMC_GetAxCaptRepeatStatus(UINT64 cardHandle, INT16 axNo, INT16* pCaptCount);
        //_DLL_API UINT32 IMC_GetAxCaptRepeatPos(UINT64 cardHandle, INT16 axNo, INT16 startNo, INT32* pCaptPosArray, INT16 count);
        ...
        [DllImport(EtherCATConfigApiDllName, EntryPoint = "IMC_GetAxCaptRepeatPos", ExactSpelling = false, CallingConvention = CallingConvention.Cdecl)]
        public static extern UInt32 IMC_GetAxCaptRepeatPos(HANDLETYPE cardHandle, Int16 axNo, Int32[] pCaptPosArray, Int16 count);
        ...
        //_DLL_API UINT32 IMC_CrdSetDOEx(UINT64 cardHandle, INT16 crdNo,INT16 doNO,INT16 doType,INT16 doLevel,INT32 userID=0);
        ...
        public static extern UInt32 IMC_CrdLineXYZEx(HANDLETYPE cardHandle, Int16 crdNo, double[] pEndPosArray, Int32 userID = 0);
        ...
        public static extern UInt32 IMC_CrdMultiSyncMove(HANDLETYPE cardHandle, Int16 CrdNO,Int16 axNum, Int16[] pAxNo , double[]  pTgtPos,double tgtVel,double tgtAcc, Int16 endFlag,Int32 UserID=0);

        //------------2021.08.05 新增Reboot Card API -----------------
        [DllImport(EtherCATConfigApiDllName, EntryPoint = "IMC_RebootCard", ExactSpelling = false, CallingConvention = CallingConvention.Cdecl)]
        public static extern UInt32 IMC_RebootCard(HANDLETYPE cardHandle);

        [DllImport(EtherCATConfigApiDllName, EntryPoint = "IMC_GetRebootCardFinish", ExactSpelling = false, CallingConvention = CallingConvention.Cdecl)]
        public static extern UInt32 IMC_GetRebootCardFinish(HANDLETYPE cardHandle,ref uint pStatus);
        #endregion
        ...
        // 获取ecat轴pdo数据
        [DllImport(EtherCATConfigApiDllName, EntryPoint = "IMC_GetEcatRawData", ExactSpelling = false, CallingConvention = CallingConvention.Cdecl)]
        public static extern UInt32 IMC_GetEcatRawData(HANDLETYPE cardHandle, Int16 ofs, UInt32 data_size, Byte[] data);
        [DllImport(EtherCATConfigApiDllName, EntryPoint = "IMC_SetEcatRawData", ExactSpelling = false, CallingConvention = CallingConvention.Cdecl)]
        public static extern UInt32 IMC_SetEcatRawData(HANDLETYPE cardHandle, Int16 ofs, UInt32 data_size, Byte[] data);
        #endregion
    }
}
